...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-BoonIt/Cartography.framework"
  install_framework "Pods-BoonIt/Kingfisher.framework"
  install_framework "Pods-BoonIt/Pages.framework"
  install_framework "Pods-BoonIt/Presentation.framework"
